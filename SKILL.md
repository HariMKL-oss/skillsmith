...
> Skillsmith is a community fork of Anthropic's `skill-creator` example skill (Apache-2.0). See NOTICE for attribution and CHANGES for what's different.
...
2. **Aggregate into benchmark** — run the aggregation script from the skillsmith directory:
   ```bash
...
4. **Launch the viewer** with both qualitative outputs and quantitative data:
   ```bash
   nohup python <skillsmith-path>/eval-viewer/generate_review.py \
